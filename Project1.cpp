...
int getTotalParamSpace(const vector<Instruction>& instructions) {
    int total = 0;
...
int getParamCount(int instructionType) {
    switch(instructionType) {
        case 1: return 2;  // Compute: iterations, cycles
        case 2: return 1;  // Print: cycles
        case 3: return 2;  // Store: value, address
        case 4: return 1;  // Load: address
        default: return 0;
    }
}
